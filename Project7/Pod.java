 ...
 * 
 * Note: ALL METHODS except the constructor will throw a MalfunctioningPodException if this pod is
 * not functioning!
 * 
 * @author hobbes >:3
 */
public class Pod {
  ...
  /**
   * A perfect-size array list of passenger names for this Pod; unoccupied seats are indicated as
   * null values
   */
  private String[] passengerList;

  /**
   * Indicator of whether this pod is currently functional; a false value will cause all methods
   * except equals/compareTo to throw a MalfunctioningPodException
   */
  ...
  /**
   * Verifies whether this Pod is currently functional. Has a 1/20 chance of causing this pod to
   * malfunction.
   * 
  ...
  public int getPodClass() throws MalfunctioningPodException {
    if (!isFunctional)
      throw new MalfunctioningPodException("Oh no!");
    return this.podClass;
  }

  /**
   * Returns the total number of passengers currently present in this Pod, defined as the number of
   * non-null elements in the passengerList
   * 
   ...
   * 
   * @return {@code true} if this Pod is carrying all of the passengers that could fit into it,
   *         {@code false} if there is still more room
   * @throws MalfunctioningPodException if this pod is not functional
   */
  ...
  public void addPassenger(String name) throws MalfunctioningPodException {
    if (isFull())
      throw new IllegalStateException("Pod is full.");
   ...
   * 
   * @return {@code true} if o is a Pod with all instance fields equal to this Pod's instance field
  ...
  public boolean equals(Object o) {
    if (!(o instanceof Pod))
      return false;
    Pod p = (Pod) o;
    return Arrays.deepEquals(this.passengerList, p.passengerList) && this.podClass == p.podClass
        && this.isFunctional == p.isFunctional;
  }
